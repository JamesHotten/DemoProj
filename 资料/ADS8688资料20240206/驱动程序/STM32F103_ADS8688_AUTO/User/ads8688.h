...
// 引脚配置
//-----------------------------------------------------------------
#define RST_L 	 		  GPIO_ResetBits(GPIOB, GPIO_Pin_8)
#define RST_H 	 		  GPIO_SetBits(GPIOB, GPIO_Pin_8)
#define DAISY_L 	 		GPIO_ResetBits(GPIOB, GPIO_Pin_9)
#define DAISY_H 	 		GPIO_SetBits(GPIOB, GPIO_Pin_9)
