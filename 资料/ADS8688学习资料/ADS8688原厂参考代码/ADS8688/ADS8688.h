...
#include "main.h"
#include "base.h"
#define ADS_8688_DAISY_IN_H HAL_GPIO_WritePin(GPIOG, GPIO_PIN_5, GPIO_PIN_SET)
#define ADS_8688_DAISY_IN_L HAL_GPIO_WritePin(GPIOG, GPIO_PIN_5, GPIO_PIN_RESET)
#define ADS_8688_SCLK_H HAL_GPIO_WritePin(GPIOG, GPIO_PIN_4, GPIO_PIN_SET)
#define ADS_8688_SCLK_L HAL_GPIO_WritePin(GPIOG, GPIO_PIN_4, GPIO_PIN_RESET)
#define ADS_8688_nCS_H HAL_GPIO_WritePin(GPIOG, GPIO_PIN_7, GPIO_PIN_SET)
#define ADS_8688_nCS_L HAL_GPIO_WritePin(GPIOG, GPIO_PIN_7, GPIO_PIN_RESET)
#define ADS_8688_RST_PD_H HAL_GPIO_WritePin(GPIOG, GPIO_PIN_2, GPIO_PIN_SET)
#define ADS_8688_RST_PD_L HAL_GPIO_WritePin(GPIOG, GPIO_PIN_2, GPIO_PIN_RESET)
#define ADS_8688_SDI_H HAL_GPIO_WritePin(GPIOG, GPIO_PIN_3, GPIO_PIN_SET)
#define ADS_8688_SDI_L HAL_GPIO_WritePin(GPIOG, GPIO_PIN_3, GPIO_PIN_RESET)
#define ADS_8688_SDO HAL_GPIO_ReadPin(GPIOG, GPIO_PIN_6)
#define NO_OP 0X0000
#define STDBY 0X8200
