...
// #define SDI_H			HAL_GPIO_WritePin(SDI_GPIO_Port,SDI_Pin,GPIO_PIN_SET)      //串行通信数据输入
// #define RST_H			HAL_GPIO_WritePin(RST_GPIO_Port,RST_Pin,GPIO_PIN_SET)     //复位
// #define DAISY_H		HAL_GPIO_WritePin(DAISY_GPIO_Port,DAISY_Pin,GPIO_PIN_SET) //以菊花链模式连接串行通信期间的数据输入
// #define CLK_H			HAL_GPIO_WritePin(CLK_GPIO_Port,CLK_Pin,GPIO_PIN_SET)   //串行通信时钟输入
// #define CS_H			HAL_GPIO_WritePin(CS_GPIO_Port,CS_Pin,GPIO_PIN_SET)   //片选

// #define SDI_L			HAL_GPIO_WritePin(SDI_GPIO_Port,SDI_Pin,GPIO_PIN_RESET)
// #define RST_L			HAL_GPIO_WritePin(RST_GPIO_Port,RST_Pin,GPIO_PIN_RESET)  //>400ns
// #define DAISY_L		HAL_GPIO_WritePin(DAISY_GPIO_Port,DAISY_Pin,GPIO_PIN_RESET)
...
// #define READ_SDO		HAL_GPIO_ReadPin(SD0_GPIO_Port,SD0_Pin)


#define SDI_H			SDI_GPIO_Port->BSRR=SDI_Pin     //串行通信数据输入
#define RST_H			RST_GPIO_Port->BSRR=RST_Pin     //复位
#define DAISY_H		DAISY_GPIO_Port->BSRR=DAISY_Pin //以菊花链模式连接串行通信期间的数据输入
#define CLK_H			CLK_GPIO_Port->BSRR=CLK_Pin   //串行通信时钟输入
#define CS_H			CS_GPIO_Port->BSRR=CS_Pin   //片选

#define SDI_L			SDI_GPIO_Port->BSRR=SDI_Pin<<16
#define RST_L			RST_GPIO_Port->BSRR=RST_Pin<<16
#define DAISY_L			DAISY_GPIO_Port->BSRR=DAISY_Pin<<16
#define CLK_L			CLK_GPIO_Port->BSRR=CLK_Pin<<16
#define CS_L			CS_GPIO_Port->BSRR=CS_Pin<<16

#define READ_SDO		((SD0_GPIO_Port->IDR & SD0_Pin)|| 0)
