...
// 引脚配置
//-----------------------------------------------------------------
#define RST_L 	 		  HAL_GPIO_WritePin(RST_GPIO_Port,RST_Pin,  GPIO_PIN_RESET)
#define RST_H 	 		  HAL_GPIO_WritePin(RST_GPIO_Port,RST_Pin,   GPIO_PIN_SET)
#define DAISY_L 	 		HAL_GPIO_WritePin(DAISY_GPIO_Port,DAISY_Pin,  GPIO_PIN_RESET)
#define DAISY_H 	 		HAL_GPIO_WritePin(DAISY_GPIO_Port,DAISY_Pin,GPIO_PIN_SET)
...
// 外部函数声明
//-----------------------------------------------------------------
//extern void GPIO_ADS8688_Configuration(void);  //cubemx GPIO配置了
