...
{
    UART3_BASE, UART1_BASE, UART2_BASE
};
...
{
    SYSCTL_PERIPH_UART3, SYSCTL_PERIPH_UART1, SYSCTL_PERIPH_UART2
};
...
//! functions: HMI_printf() or UARTgets().  This function assumes that the
...
//*****************************************************************************
int
HMI_write(const char *pcBuf, uint32_t ui32Len)
{
#ifdef UART_BUFFERED
    unsigned int uIdx;
...
//*****************************************************************************
int
HMI_gets(char *pcBuf, uint32_t ui32Len)
{
#ifdef UART_BUFFERED
...
//*****************************************************************************
void
HMI_vprintf(const char *pcString, va_list vaArgP)
{
...
//*****************************************************************************
void
HMI_printf(const char *pcString, ...)
{
    va_list vaArgP;
...
//! HMI_printf() that is waiting to be transmitted.  On return, the transmit
...
void HMI_Configure() {
    ...
    UARTStdioConfig(0, 115200, 120e6);
}
