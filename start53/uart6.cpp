...
{
    UART6_BASE, UART1_BASE, UART2_BASE
};
...
{
    SYSCTL_PERIPH_UART6, SYSCTL_PERIPH_UART1, SYSCTL_PERIPH_UART2
};
...
//! functions: BT_printf() or UARTgets().  This function assumes that the
...
//*****************************************************************************
int
BT_write(const char *pcBuf, uint32_t ui32Len)
{
#ifdef UART_BUFFERED
    unsigned int uIdx;
...
//*****************************************************************************
int
BT_gets(char *pcBuf, uint32_t ui32Len)
{
#ifdef UART_BUFFERED
...
//*****************************************************************************
void
BT_vprintf(const char *pcString, va_list vaArgP)
{
...
//! BT_printf() that is waiting to be transmitted.  On return, the transmit
