...
//! functions: UART_printf() or UARTgets().  This function assumes that the
...
//*****************************************************************************
int
UART_write(const char *pcBuf, uint32_t ui32Len)
{
#ifdef UART_BUFFERED
    unsigned int uIdx;
...
//*****************************************************************************
int
UART_gets(char *pcBuf, uint32_t ui32Len)
{
#ifdef UART_BUFFERED
...
//*****************************************************************************
void
UART_vprintf(const char *pcString, va_list vaArgP)
{
...
//*****************************************************************************
void
UART_printf(const char *pcString, ...)
{
    va_list vaArgP;
...
//! UART_printf() that is waiting to be transmitted.  On return, the transmit
